  ...
  return (
    <div className="flex flex-col gap-3 w-full max-w-sm">
      <Button
        ...
        className={`w-full relative font-semibold transition-all h-12 ${
          isFollowing
      ...
      <Button
        onClick={onMessage}
        variant="outline"
        className="w-full border-blue-400 text-blue-700 hover:bg-blue-200/60 hover:text-blue-900 h-12"
      >
      ...
      <div className="flex gap-3">
        <Button
          ...
          className={`flex-1 border-pink-400 hover:text-pink-900 h-12 ${
            isSaved 
        ...
        <Button
          onClick={onRequest}
          variant="outline"
          className="flex-1 border-yellow-400 text-amber-800 hover:bg-amber-100/70 hover:text-amber-900 h-12"
        >
