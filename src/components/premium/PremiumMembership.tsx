...
const PremiumMembership = () => {
  ...
  return <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="text-center space-y-4">
        ...
        {isActive && <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-4 py-2">
            <CheckCircle className="h-5 w-5 text-green-600" />
            <span className="text-green-700 font-semibold">Premium Active</span>
          </div>}
      </div>

      {isActive ? <div className="space-y-8">
          {/* Premium Status Card */}
          <Card className="relative overflow-hidden">
            ...
            }].map((feature, index) => <div key={index} className="text-center p-4 bg-white/60 backdrop-blur-sm rounded-lg border border-white/40">
