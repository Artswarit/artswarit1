...
const Slider = React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root>>(({
  ...
  ...props
    ...
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-secondary text-orange-800">
      <SliderPrimitive.Range className="absolute h-full bg-primary text-lime-300" />
