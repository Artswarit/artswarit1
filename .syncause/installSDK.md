...
```powershell
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Syncause/ts-agent-file/v1.6.0/install_probe.bat" -OutFile "install_probe.bat"; .install_probe.bat
```
...
apikey: sysk_IECjjKMRP5kcojeYrTtFDIyMbPl2f4
appName: artswarit1
projectId: {projectId}
