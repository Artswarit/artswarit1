...
import { 
  CheckCircle, MapPin, Calendar, Globe, Building2, User, 
  MessageSquare, Clock, Circle
} from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row items-start gap-4 -mt-12 sm:-mt-16">
          ...
          <div className="flex-1 pt-4 sm:pt-8">
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              {locationDisplay && (
                <div className="flex items-center gap-1.5 text-muted-foreground bg-muted/50 px-2.5 py-1.5 rounded-full text-xs">
              ...
              {profile.website && (
                <a 
                  ...
                  className="flex items-center gap-1.5 text-muted-foreground hover:text-primary bg-muted/50 px-2.5 py-1.5 rounded-full text-xs transition-colors"
                >
