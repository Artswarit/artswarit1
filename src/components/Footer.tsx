        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 md:gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-3 text-sm text-muted-foreground max-w-xs">
              The platform where artists showcase their talent, build professional
              portfolios, and monetize their work.
            </p>
          </div>

          {/* For Artists */}
          <nav aria-label="For artists" className="space-y-3">
          ...
          {/* For Clients */}
          <nav aria-label="For clients" className="space-y-3">
            <h2 className="text-sm font-semibold tracking-wide text-foreground">
              For Clients
            </h2>
            <ul className="space-y-2">
